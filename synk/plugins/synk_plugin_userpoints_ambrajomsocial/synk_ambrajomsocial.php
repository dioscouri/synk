...
/**
 * Synk Ambra and JomSocial User Points
 * 
 * Supported custom JomSocial Events
 * 
 * onSystemStart - This event trigger before any controller is called
 * 
 */


if(!class_exists('plgCommunityAmbraJomsocialSynk'))
{
	class plgCommunityAmbraJomsocialSynk extends CApplications 
	{
		 ...
		 * @since 1.5
		 */
		function plgCommunityAmbraJomsocialSynk( &$subject, $params )
		{
	     ...
	     * @return boolean  if the plugin wants to override the controller class name 
	     */
		 ...
		 * @return boolean
		 */
		function &runUserPointsynchronization( $synk, &$options ) 
		{
			// init variables
			$user 		= $options['user'];
			$isnew 		= $options['isnew'];
