	...
	<table class="adminlist" style="clear: both;">
		<thead>
            <tr>
                ...
                <th>
                	<?php echo SynkGrid::sort( 'Type', "tbl.type", @$state->direction, @$state->order ); ?>
                </th>
                <th>
            ...
            <tr class="filter">
                ...
                <th style="text-align: center;">
                    <?php echo SynkSelect::typetype( @$state->filter_typeid, 'filter_typeid', $attribs, 'typeid', true, false, 'Select Type' ); ?>
                </th>
                <th style="text-align: center;">
